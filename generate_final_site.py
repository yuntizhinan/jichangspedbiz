...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../css/style.css?v=20260724?v=20260724">
  <style>
...
<body>
  ...
  <script src="../js/main.js?v=20260724?v=20260724"></script>
</body>
</html>"""
if __name__ == '__main__':
    # Ensure articles directory exists without deleting other files
